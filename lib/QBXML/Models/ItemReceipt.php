<?php
	 ...
	 */
	class ItemReceipt extends GenericObject {
		/**
		...
		*/
		 ...
		 *
		 * @param int $i a number between 0 and added Lines-1
		 */
		...
		public function asList($request) {
			switch($request) {
				...
				case QUICKBOOKS_MOD_ITEMRECEIPT . 'Rq':
					if(isset($this->_object['ItemLine'])) {
				...
				case QUICKBOOKS_QUERY_ITEMRECEIPT . 'Rq':
					if(isset($this->_object['ItemLine'])) {
		...
		public function asXML($root = null, $parent = null, $object = null) {
			...
			switch($root) {
				...
				case QUICKBOOKS_QUERY_RECEIPTITEM:
					...
					break;
				*/
				case QUICKBOOKS_MOD_ITEMRECEIPT:
					if(isset($object['ItemLineAdd'])) {
