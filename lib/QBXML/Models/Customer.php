<?php
	 ...
	 */
	class Customer extends GenericObject {
		/**
		...
		public function getShipAddressBlock($part = null, $defaults = []) {
		...
		public function getCustomerTypeApplicationID() {
			return $this->get('CustomerTypeRef ');
		}
		 ...
		 */
		public function getCreditCardInfo($part = null, $defaults = []) {
			if(!is_null($part)) {
